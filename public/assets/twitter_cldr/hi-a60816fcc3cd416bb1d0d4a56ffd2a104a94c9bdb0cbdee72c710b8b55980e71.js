  ...
  TwitterCldrDataBundle = {
    ...
    "PluralRules": {
      "rules": {
        ...
        "ordinal": "(function(num, runtime) { var n = runtime.n(num); var i = runtime.i(num); var v = runtime.v(num); var w = runtime.w(num); var f = runtime.f(num); var t = runtime.t(num); return (n == 4 ? 'few' : (n == 6 ? 'many' : (n == 1 ? 'one' : (((n == 2) || (n == 3)) ? 'two' : 'other')))); })"
      },
      "names": {
        "cardinal": ["one", "other"],
