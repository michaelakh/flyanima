...
(function() {
  ...
  TwitterCldrDataBundle = {
    ...
    "PluralRules": {
      "rules": {
        "cardinal": "(function(num, runtime) { var n = runtime.n(num); var i = runtime.i(num); var v = runtime.v(num); var w = runtime.w(num); var f = runtime.f(num); var t = runtime.t(num); return (((n \u003e= 3) \u0026\u0026 (n \u003c= 6)) ? 'few' : (((n \u003e= 7) \u0026\u0026 (n \u003c= 10)) ? 'many' : (n == 1 ? 'one' : (n == 2 ? 'two' : 'other')))); })",
