  ...
  TwitterCldrDataBundle = {
    ...
    "PluralRules": {
      "rules": {
        ...
        "ordinal": "(function(num, runtime) { var n = runtime.n(num); var i = runtime.i(num); var v = runtime.v(num); var w = runtime.w(num); var f = runtime.f(num); var t = runtime.t(num); return ((((n % 10 == 1) || (n % 10 == 2)) \u0026\u0026 ((n % 100 != 11) \u0026\u0026 (n % 100 != 12))) ? 'one' : 'other'); })"
      },
      "names": {
        "cardinal": ["one", "other"],
        "ordinal": ["one", "other"]
    ...
    "Calendar": {
      "calendar": {
        ...
        "eras": {
          ...
          "name": {
            "0": "före västerländsk tideräkning",
            "1": "västerländsk tideräkning"
          },
          "narrow": {
            "0": "fvt",
            "1": "vt"
