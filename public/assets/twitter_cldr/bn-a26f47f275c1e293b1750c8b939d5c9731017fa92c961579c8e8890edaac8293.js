...
(function() {
  ...
  TwitterCldrDataBundle = {
    ...
    "PluralRules": {
      "rules": {
        "cardinal": "(function(num, runtime) { var n = runtime.n(num); var i = runtime.i(num); var v = runtime.v(num); var w = runtime.w(num); var f = runtime.f(num); var t = runtime.t(num); return ((i == 0 || n == 1) ? 'one' : 'other'); })",
        "ordinal": "(function(num, runtime) { var n = runtime.n(num); var i = runtime.i(num); var v = runtime.v(num); var w = runtime.w(num); var f = runtime.f(num); var t = runtime.t(num); return (n == 4 ? 'few' : (n == 6 ? 'many' : (((n == 1) || (n == 5) || (n == 7) || (n == 8) || (n == 9) || (n == 10)) ? 'one' : (((n == 2) || (n == 3)) ? 'two' : 'other')))); })"
      },
      "names": {
        "cardinal": ["one", "other"],
    ...
    "Languages": {
      "all": {
        ...
        "en-GB": "যুক্তরাজ্যের ইংরেজি",
        "en-US": "যুক্তরাষ্ট্রের ইংরেজি",
        "enm": "মধ্য ইংরেজি",
        "eo": "এস্পেরান্তো",
        "es": "স্প্যানিশ",
